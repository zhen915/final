...
html_temp = """
		...
		<h1 style="color:white;text-align:center;">金融期末 </h1>
		<h2 style="color:white;text-align:center;">Final </h2>
		</div>
		"""
stc.html(html_temp)
...
## 读取Pickle文件
df_original = pd.read_pickle('kbars_2330_2020-01-01-2024-06-20.pkl')
